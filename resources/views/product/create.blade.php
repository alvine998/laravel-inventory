                    ...
                    <div class="card-body">
                        <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('total_unit') is-invalid @enderror" name="total_unit" value="{{ old('total_unit') }}" placeholder="Masukkan Jumlah Barang">
                            
                                <!-- error message untuk total_unit -->
                                @error('total_unit')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('notes') is-invalid @enderror" name="notes" rows="5" placeholder="Masukkan Keterangan">{{ old('notes') }}</textarea>
